...
// enqueue css
function hus_common_custom_css(){
    
    wp_enqueue_style( 'hus-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= hus_opt( 'hus_theme_color' ) != '#131313' ? hus_opt( 'hus_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= hus_opt( 'hus_book_btn_color' ) != '#131313' ? hus_opt('hus_book_btn_color') : '';
		$bookBtnHoverBgColor     	= hus_opt( 'hus_book_btn_hvr_bg_color' ) != '#131313' ? hus_opt('hus_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = hus_opt( 'hus_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = hus_opt( 'hus_navbar_bg_color' ) != '#082b49' ? hus_opt( 'hus_navbar_bg_color') : '';
		$headerTop_col     		  = hus_opt( 'hus_top_header_color' );

		$headerTopBg      		  = hus_opt( 'hus_top_header_bg_color');
		$headerBg          		  = hus_opt( 'hus_header_bg_color') != '#ffffff' ? hus_opt( 'hus_header_bg_color') : '';
		$menuColor          	  = hus_opt( 'hus_header_menu_color' ) != '#131313' ? hus_opt('hus_header_menu_color') : '';
		$menuHoverColor           = hus_opt( 'hus_header_menu_hover_color' ) != '#808080' ? hus_opt('hus_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = hus_opt( 'hus_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = hus_opt( 'hus_header_drop_menu_bg_color' ) != '#ffffff' ? hus_opt('hus_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = hus_opt( 'hus_dropdown_menu_color' ) != '#131313' ? hus_opt('hus_dropdown_menu_color') : '';
		$dropMenuHovColor         = hus_opt( 'hus_dropdown_menu_hover_color' ) != '#808080' ? hus_opt('hus_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = hus_opt( 'hus_footer_widget_bg_color' );
		$footerwHeadColor   	  = hus_opt('hus_footer_widget_heading_color');
		$footerwTextColor   	  = hus_opt('hus_footer_widget_text_color');
		$footerwanchorcolor 	  = hus_opt('hus_footer_widget_anchor_color') != '#ffffff' ? hus_opt('hus_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = hus_opt('hus_footer_widget_anchor_hover_color') != '#ffffff' ? hus_opt('hus_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = hus_opt('hus_fof_bg_color');
		$foftonecolor			  = hus_opt('hus_fof_textone_color');
		$fofttwocolor			  = hus_opt('hus_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = hus_opt('hus_footer_widget_anchor_color') != '#9e9e9e' ? hus_opt('hus_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .hus_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .hus_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'hus-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'hus_common_custom_css', 50 );