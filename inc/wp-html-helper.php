...
// image default alt
if ( ! function_exists( 'hus_img_default_alt' ) ) {
	function hus_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'hus_img_tag' ) ) {
	function hus_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'hus_anchor_tag' ) ) {
	function hus_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'hus_heading_tag' ) ) {
	function hus_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'hus_paragraph_tag' ) ) {
	function hus_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'hus_other_tag' ) ) {
	function hus_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'hus_button_element ' ) ) {
	function hus_button_element( array $args ) {
