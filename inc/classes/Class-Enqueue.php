 ...
 */
	...
	class hus_Enqueue{
		...
		public function hus_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'hus_frontend_enqueue_scripts', ) );
		}

		public function hus_frontend_enqueue_scripts( ){
