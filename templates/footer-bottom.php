<?php 		
	...
	$copyRight = !empty( hus_opt( 'hus_footer_copyright_text' ) ) ? hus_opt( 'hus_footer_copyright_text' ) : $copyText;
	?>
            ...
            <div class="footer_border"></div>
				<div class="row">
                    ...
                    <div class="col-lg-4">
						<?php
						// Social profiles
						$social_opt = hus_opt('hus_social_profile_toggle');
						if ( $social_opt == true ) {
							$social_items = hus_opt('hus_social_profiles');
